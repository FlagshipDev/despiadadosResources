webpackJsonp([0], [, , , , , , function (t, e, n) {
                    ...
                    var e = p()(c.a.mark(function t(e, n) {
                        ...
                        return c.a.wrap(function (t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return s = void 0 === n ? "{}" : l()(n), t.next = 3, window.jQuery.post("http://ftp_phone/" + e, s);
                                case 3:
    ...
    function i(t) {
        ...
        g.locale = "es_ES", g.locales = {}, t.prototype.$timeago = {
    ...
    var a = n(21),
        ...
        f = 365 * l,
        d = {
            es_ES: ["ahora", ["hace %s segundo", "hace %s segundos"],
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        methods: {
            updateTime: function () {
                ...
                n = n > 9 ? n : "0" + n;
                var s = n + ":" + e;
                this.time = s, this.gametime = window.gametime
            }
        },
        created: function () {
    ...
    e.default = {
        ...
        methods: o()({}, n.i(i.a)(["closePhone", "setMessages"]), {
            ...
            onEnter: function () {
                this.openApp(this.AppsHome.slice(0, 4)[this.currentSelect] || {
                    routeName: "menu"
                })
            },
            onBack: function () {
            ...
            deleteC: function () {
                ...
                if (-1 !== this.id) {
                    ...
                    c.a.CreateModal({
                        ...
                        t.ignoreControls = !1, e.title === t.IntlString("APP_CONTACT_DELETE") && (t.$phoneAPI.deleteContact(t.id), history.back())
                    })
                } else history.back()
            }
        }),
    ...
    t.exports = {
        render: function () {
            ...
            return n("div", {
            ...
            }, [t._l(t.AppsHome.slice(0, 4), function (e, s) {
                return n("button", {
                    key: e.name,
                    class: {
                        select: s === t.currentSelect
                ...
                class: {
                    select: t.AppsHome.slice(0, 4).length === t.currentSelect
                },
                style: {
    ...
    t.exports = {
        render: function () {
            var t = this,
                e = t.$createElement;
            return (t._self._c || e)("span", [t._v(t._s(t.gametime))])
        },
        staticRenderFns: []
    }
}, , , function (t, e) {
