			...
			'<div class="menu-items">' + 
				'{{#elements}}' +
					'<div class="menu-item {{#selected}}selected{{/selected}}">' +
						'{{#showImage}}<img class="ItemImage" onerror="this.style.display=\'none\'" src="https://leyendasrp.es/{{{value}}}.png"/>{{/showImage}}{{{label}}}{{#isSlider}} : &lt;<span style="color:orange">{{{sliderLabel}}}</span>&gt;{{/isSlider}}' +
					'</div>' +
				'{{/elements}}' +
			'</div>'+
