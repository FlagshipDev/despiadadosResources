...
function startIntro() {
    ...
    showIntro(true, "Despiadados Community presenta");
    ...
    setTimeout(showIntro, 34500, true, "Iniciando Despiadados... Entrarás ahora, ten paciencia.");
...
function doMask(count) {
    switch(count) {
        ...
        case 4:
            ...
            $("#credit-a").css("text-align", "left");
            $("#credit-b").html("<h1>OnDev...</h1><p>?</p><p>?</p><p>?</p><p>?</p><p>?</p>");
            $("#credit-b").css("margin", "170px 0px 0px -160px");
            $("#credit-b").css("text-align", "left");
            $("#credit-c").html("<h1>OnDev</h1><p>?</p><p>?</p><p>?</p><p>?</p><p>?</p>");
