...
--SMG
	{
		...
		components = {
			...
			{name = 'flashlight', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH')},
			{name = 'holographic', label = _U('component_holographic'), hash = GetHashKey('COMPONENT_AT_SIGHTS_SMG')},
			{name = 'suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_PI_SUPP')},
		}
	},
-- ESCOPETAS
	{
		...
		components = {
			{name = 'clip_default', label = _U('component_clip_default'), hash = GetHashKey('COMPONENT_PUMPSHOTGUN_MK2_CLIP_01')},
			{name = 'clip_extended', label = _U('component_clip_extended'), hash = GetHashKey('COMPONENT_PUMPSHOTGUN_MK2_CLIP_INCENDIARY')},
			{name = 'flashlight', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH')},
			{name = 'holographic', label = _U('component_holographic'), hash = GetHashKey('COMPONENT_AT_SIGHTS')},
