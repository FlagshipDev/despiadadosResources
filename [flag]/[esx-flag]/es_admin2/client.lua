...
RegisterNetEvent('getPlayersClient')
AddEventHandler('getPlayersClient', function(_players)
...
AddEventHandler('es_admin:quick', function(t, target)
	...
	if t == "noclip" then
		...
		TriggerEvent("chatMessage", "^6LeyendasRP: ", {255, 0, 0}, "El NoClip ha sido  ^2^*" .. msg)
	end
	if t == "freeze" then
