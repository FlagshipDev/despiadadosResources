...
AddEventHandler('playerConnecting', function(name, setKickReason)
	...
	if not id then
		setKickReason("No hemos podido encontrar el ID de steam, reinicia FiveM con Steam abierto - LeyendasRP")
		CancelEvent()
	end
end)
...
AddEventHandler('es:firstJoinProper', function()
	...
	Citizen.CreateThread(function()
		...
		if not id then
			DropPlayer(Source, "No hemos podido encontrar el ID de steam, reinicia FiveM con Steam abierto - LeyendasRP")
		else
