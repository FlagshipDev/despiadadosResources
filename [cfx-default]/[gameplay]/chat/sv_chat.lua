...
AddEventHandler('playerJoining', function()
    ...
    TriggerClientEvent('chatMessage', -1, '', { 255, 255, 255 }, '^3' .. GetPlayerName(source) .. ' se ha unido')
end)
...
AddEventHandler('playerDropped', function(reason)
    ...
    TriggerClientEvent('chatMessage', -1, '', { 255, 255, 255 }, '^3' .. GetPlayerName(source) ..' se ha desconectado')
end)
