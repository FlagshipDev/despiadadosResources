...
function OpenLicenseShop()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'license_shop_actions', {
		...
		elseif data.current.value == 'buy_license_commercial' then
			...
			ESX.ShowNotification("Has comprado la licencia vehiculos pesados.")
			IsInMainMenu = false
			menu.close()
		elseif data.current.value == 'buy_license_drivers' then
			TriggerServerEvent('esx_licenseshop:buyLicenseDrivers')
			ESX.ShowNotification("Has comprado la licencia de turismos.")
			IsInMainMenu = false
			menu.close()
		...
		elseif data.current.value == 'buy_license_motorcycle' then
			...
			ESX.ShowNotification("Has comprado la licencia de motocicletas.")
			IsInMainMenu = false
			menu.close()
		...
		elseif data.current.value == 'buy_license_weapon' then
			...
			ESX.ShowNotification("Has comprado la licencia de armas.")
			IsInMainMenu = false
			menu.close()
		end
