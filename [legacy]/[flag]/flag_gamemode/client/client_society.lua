...
function OpenBossMenu(society, close, options)
	...
	ESX.TriggerServerCallback('esx_society:getMoney', function(money)
		dineroSociedad = money
	end, society)

	table.insert(elements, {label = 'Ver dinero de la empresa', value = 'empresadinero'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'boss_actions_' .. society, {
		...
		elseif data.current.value == 'empresadinero' then
			ESX.ShowNotification('La empresa tiene '.. dineroSociedad..'~g~$')
